...
- UI: React 18, Tailwind CSS, Zustand, TanStack Query v5
- Offline DB: PGlite + ElectricSQL — https://electric-sql.com/docs (Dexie.js YASAK)
- Backend: Fastify 4 — https://fastify.dev/docs/latest/, Node.js 20 LTS
- BaaS: Supabase (PostgreSQL + Auth + Realtime + Storage) — https://supabase.com/docs
- Cache: Redis 7+
- Mobile: React Native 0.76 — https://reactnative.dev/docs/getting-started
- AI: yapılandırılabilir (AI_MODE=api|local, varsayılan: yerel model)
- Toast: react-hot-toast (başka toast lib yasak)
- Form: react-hook-form + zod — https://zod.dev
- Test: Vitest — https://vitest.dev/guide/ + Playwright — https://playwright.dev/docs/intro
- mDNS: mdns-js (yazıcı keşfi için) — https://github.com/mdns-js/node-mdns-js
